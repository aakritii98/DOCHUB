...
const resettcreq =async(data)=>{
    $.ajax({
        method:'PUT',
        url:'http://localhost:3000/teachforgotpassword',
        data: data,
        dataType: 'json',
        success(data){
...
const ResetTeachClicks = ()=>{
    $('#resetpass').unbind();
    $('#resetsubmit').click(()=>{
        getTeachInputValuesResetPass()
    });
} 
